...
if [ -n "$ENGINE_CONTAINER" ]; then
	...
	echo "java -Xmx256M -XX:MaxPermSize=256M -Djava.security.policy=security.policy -Dcyc.home=.  -jar engine-container-jar-with-dependencies.jar" >$CYC_ENGINE_CONTAINER/run.sh
